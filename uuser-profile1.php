...
<!-- Mirrored from themesbrand.com/skote-django/layouts/contacts-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 18 Apr 2021 19:48:19 GMT -->
<head>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <h5 class="font-size-15 text-truncate">David McHenry</h5>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted mb-4">Hi I'm David McHenry,has been the industry's standard dummy text To an English person, it will seem like simplified English, as a skeptical Cambridge.</p>
                            ...
                            <div class="col-xl-8">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <p class="text-muted fw-medium mb-2">Completed Lead</p>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <p class="text-muted fw-medium mb-2">Pending Lead</p>
                                                        <h4 class="mb-0">12</h4>
                                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">My Lead</h4>
                                        <div class="table-responsive">
